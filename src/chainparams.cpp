...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("1", "seed01.HCASH.com"));      // Crypto Dezire Cash's official seed 1
        vSeeds.push_back(CDNSSeedData("2", "seed02.HCASH.com"));      // Crypto Dezire Cash's official seed 2
        vSeeds.push_back(CDNSSeedData("3", "seed03.HCASH.com"));      // Crypto Dezire Cash's official seed 3
...
public:
    CTestNetParams()
    {
        ...
        // Testnet HCASH BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet HCASH BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet HCASH BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        genesis.nNonce = 1;                // hex 57 47 52 in text = HCASH
