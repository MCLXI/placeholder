...
enum ZerocoinSpendStatus {
    ...
    ZHCASH_TX_TOO_LARGE = 15,                          // The transaction is larger than the max tx size
    ZHCASH_SPEND_V1_SEC_LEVEL                         // Spend is V1 and security level is not set to 100
};
...
public:
    ...
    bool CreateZHCASHOutPut(libzerocoin::CoinDenomination denomination, CTxOut& outMint, CDeterministicMint& dMint);
    ...
    */
    ...
    CzHCASHWallet* zwalletMain;

    bool fFileBacked;
    bool fWalletUnlockAnonymizeOnly;
    std::string strWalletFile;
    bool fBackupMints;
    std::unique_ptr<CzHCASHTracker> zcdzcTracker;
    ...
    void setZWallet(CzHCASHWallet* zwallet)
    {
        zwalletMain = zwallet;
        zcdzcTracker = std::unique_ptr<CzHCASHTracker>(new CzHCASHTracker(strWalletFile));
    }

    CzHCASHWallet* getZWallet() { return zwalletMain; }
    ...
    /** zHCASH reset */
    boost::signals2::signal<void()> NotifyzHCASHReset;
