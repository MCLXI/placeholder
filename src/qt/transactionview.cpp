 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZGLPM));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGLPM"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCdzc));
