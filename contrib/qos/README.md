...
This means one can have an always-on HCASHd instance running, and another local HCASHd/HCASH-qt instance which connects to this node and receives blocks from it.
