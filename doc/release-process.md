...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/HCASH/HCASH/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/HCASH/HCASH/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/HCASH/HCASH.git
...
### Build and sign Bitcoin Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --num-make 2 --memory 3000 --commit HCASH=v${VERSION} ../HCASH/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit HCASH=v${VERSION} ../HCASH/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit HCASH=v${VERSION} ../HCASH/contrib/gitian-descriptors/gitian-osx.yml
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys: See `../HCASH/contrib/gitian-keys/README.md`.
...
- Detached signatures will then be committed to the [HCASH-detached-sigs](https://github.com/HCASH/HCASH-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the HCASH.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the HCASH.org server
  into `/var/www/bin/HCASH-${VERSION}`
...
people without access to `HCASH.org` to download the binary distribution.
Also put it into the `optional_magnetlink:` slot in the YAML file for
HCASH.org (see below for HCASH.org update instructions).

- Update HCASH.org version

  - First, check to see if the Bitcoin.org maintainers have prepared a
    release: https://github.com/HCASH-dot-org/HCASH.org/labels/Releases
  ...
  - If they have not prepared a release, follow the Bitcoin.org release
    instructions: https://github.com/HCASH-dot-org/HCASH.org#release-notes
...
- Announce the release:
  ...
  - HCASH-dev and HCASH-dev mailing list

  - Bitcoin Core announcements list https://HCASHcore.org/en/list/announcements/join/

  - HCASHcore.org blog post

  - Update title of #HCASH on Freenode IRC

  - Optionally twitter, reddit /r/Bitcoin, ... but this will usually sort out itself

  - Notify BlueMatt so that he can start building [the PPAs](https://launchpad.net/~HCASH/+archive/ubuntu/HCASH)

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/HCASH/HCASH/releases/new) with a link to the archived release notes.
