...
In order to support loading of multiple wallets in HCASH-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is HCASH.cpp.
...
Changes to HCASH.cpp
----------------------
HCASH.cpp is the entry point into HCASH-qt, and as such, will require some minor modifications to provide hooks for
